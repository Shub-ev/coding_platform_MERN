  ...
  return (
    <div className='Navbar flex relative items-center justify-between px-[3%] xs:pt-[4%] xs:pb-[6%] lg:pt-[1%] lg:pb-[2%]'>
      ...
      <div className='flex items-center xs:gap-4 md:gap-6 lg:gap-8'>
        ...
        <ul className={`mbView xs:absolute xs:right-[3%] xs:top-12 bg-white xs:border-[1px] xs:px-[16px] xs:py-[14px] flex xs:flex-col xs:gap-2 xs:border-slate-500 ${displayMenu ? "" : "xs:hidden"} md:flex md:flex-col lg:flex lg:flex-row justify-center lg:items-center lg:border-none lg:gap-14 lg:right-0 lg:top-0 cursor-pointer`}>
